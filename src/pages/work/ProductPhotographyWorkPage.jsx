// src/pages/work/PhotographyContentWorkPage.jsx
...
const photographySamples = [
  { type: "image", src: "https://images.unsplash.com/photo-1514933651103-005eec06c04b" },
  ...
  { type: "image", src: "https://images.unsplash.com/photo-1542838132-92c53300491e" },
  { type: "image", src: "https://images.unsplash.com/photo-1481833761820-0509d3217039" },
];

export default function PhotographyContentWorkPage() {
  const { filteredItems, typeFilter, setTypeFilter } = useWorkFilter(photographySamples);

  const category = {
    title: "Lifestyle & Photography",
    description:
      "Cafe, product, and lifestyle visuals shot and edited to be social-first and brand-aligned.",
    media: filteredItems,
  };
